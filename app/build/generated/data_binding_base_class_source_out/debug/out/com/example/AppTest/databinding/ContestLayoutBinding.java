...
public final class ContestLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private ContestLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ContestLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContestLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.contest_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContestLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContestLayoutBinding((ConstraintLayout) rootView, cfb2, labelup, myList,
          textView10, view);
    }
